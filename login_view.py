        ...
        def switch_tab(tab: str):
            ...
            if tab == "login":
                ...
                action_btn.content = ft.Row([
                    ft.Icon(ft.Icons.LOGIN, size=16, color="#000000"),
                    ft.Text("Sign In", size=14, weight=ft.FontWeight.W_700, color="#000000"),
                ...
                action_btn.content = ft.Row([
                    ft.Icon(ft.Icons.PERSON_ADD, size=16, color="#000000"),
