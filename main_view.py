...
def _btn(text, on_click, icon=None, bgcolor=ACCENT, fgcolor="#000000"):
...
def _role_badge(role: str):
    ...
    return ft.Container(
        content=ft.Text(role.upper(), color="#000000" if role == "admin" else "white",
    ...
    def _open_edit_user(self, uid: int, msg_text: ft.Text, refresh_fn):
        ...
        dlg = ft.AlertDialog(
            ...
            actions=[
                ...
                ft.ElevatedButton(
                    content=ft.Text("Save", color="#000000", size=13,
                                    weight=ft.FontWeight.W_600),
                    on_click=do_save,
                    style=ft.ButtonStyle(
                        bgcolor=ACCENT,
